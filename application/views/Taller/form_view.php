...
<div class="content-wrapper">
  ...
  <section class="content">
          ...
          <div class="row">
            <div class="col-xs-12 col-md-12 col-lg-6">
              <div class="form-group">
                ...
                <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Escriba aquí"
                  required="required">
              </div>
              <div class="form-group">
                <label for="">Lugar del taller</label>
                <input type="text" name="lugar" id="lugar" class="form-control" placeholder="Escriba aquí"
                  required="required">
              </div>
              <div class="form-group">
                <label for="">Cupo del taller</label>
                <input type="number" name="cupo" id="cupo" class="form-control" placeholder="0" min="1" max="100"
                  required="required">
              </div>
              <div class="form-group">
            ...
            <div class="col-xs-12 col-md-12 col-lg-6">
              ...
              <div class="form-group">
                ...
                <input type="email" name="correo" id="correo" class="form-control" placeholder="Escriba aquí"
                  required="required">
              </div>
              <div class="form-group">
                <label for="">¿Trabajas?</label>
                <input type="radio" name="trabaja" id="trabaja1" required="required">Sí
                <input type="radio" name="trabaja" id="trabaja2" required="required" checked>No
              </div>
              <div class="form-group" id="lugar_trabajo" style="display:none;">
    ...
    <div class="card card-success">
      <div class="card-header">
        <h4 class="card_title">Talleres Registrados</h4>
      </div>
      <div class="card-body">
