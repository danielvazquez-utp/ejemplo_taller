                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nombre" id="nombre" class="form-control"
                                    placeholder="Escriba aquí" required="required">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="cupo" id="cupo" class="form-control" placeholder="0" min="1"
                        ...
                        <div class="col-xs-12 col-md-12 col-lg-6">
                            ...
                            <div class="form-group" id="div_trabaja" style="display:none;">
                                ...
                                <input type="text" name="donde" id="donde" class="form-control"
